...
app.get('/landmarktechnologies', function(request, response) {
    ...
    response.write("<h2><center>Welcome to  ColdEnergy Teck. Please Contact +18254316146 for more information or send an email to info@mylandmarktech.com <center></h2>" );
    response.end();
