...
*/
app.get('/coldenergyteck', function(request, response) {
    //response.send("<h2><center>Welcome to Node JS app develpoed by MyLandmarkTech</h2>");
    response.write("<h2><center><u>Node JS  Application </u></center></h2>");
	
    response.write("<h2><center>Welcome to  ColdEnergy Teck. Please Contact +18254316146 for more information or send an email to coldenergyteck@yahoo.com <center></h2>" );
    response.end();
